...
const TerminalNavbar = () => {
  ...
  return (
    <div className='min-w-full h-10 px-4 py-3 flex justify-start items-center bg-gray-100'>
      ...
      { reports &&   <div className="absolute">
...
{/*   
    <div>
         <button className="rounded-full bg-gray-300 text-gray-800 flex items-center justify-center">+</button>
         <button className="w-fit px-4 py-2 bg-gradient-to-bl:(bg-red-500 bg-red-200)">GET PRO</button>
    </div> */}
    </div>
  )
}
