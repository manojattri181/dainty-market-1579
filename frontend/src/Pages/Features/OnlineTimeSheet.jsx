...
import { Button, createIcon, HStack, Input, FormControl,Container, Box, Image,Text, VStack, Heading, border, textDecoration, Spacer, color, Stack} from "@chakra-ui/react";
    ...
    <Box>
            ...
            <FormControl style={styles.form} flexDirection={{base:"column", lg:"row"}}  >
                ...
                <HStack margin="auto" mt={{base:"10px"}} >
                    ...
                    <Text style={styles.googleText} _hover={{color:"#ed565a"}}>Sigin in with Google</Text>
                </HStack>
                <VStack >
            ...
            <Text style={styles.lastHeading}> DON’T WASTE TIME WITH OLDFASHIONED TIMESHEETS. </Text>
                <Button style={styles.formButton} width={{base:"80%", lg:"20%"}} display="flex" margin="auto" mb="50px">START FOR FREE TRAIL</Button>
