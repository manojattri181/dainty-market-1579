...
const TopSection = () => {
  ...
  return (
    <div
      className=" lg:text-left mt-10 md:text-center"
      //   style={{
      //     backgroundImage:
      //       "https://trackingtime.co/wp-content/themes/trackingtime-v5/img/layout/integrations/lines-integration.svg",
      //   }}
    >
      <p className=" lg:text-xl text-base font-semibold lg:font-bold tracking-widest">
        TRACKING TIME BUTTON FOR CHROME
      </p>
      <p className=" lg:text-6xl text-4xl mt-6 font-bold">TrackingTime</p>
      <p className="lg:text-6xl text-4xl mt-2 font-bold">Integrations</p>
        ...
        <>
          <div className="flex">
            <input
              ...
              className=" border-2 mt-16 w-2/4 placeholder:text-current placeholder:font-bold
       p-6 shadow-lg "
            />
